...
from data import VOCroot, COCOroot, COCO_train_year, VOC_300, VOC_512, COCO_300_mod, COCO_512, COCO_mobile_300, AnnotationTransform, \
...
if args.dataset == 'VOC':
    ...
    train_sets = [(COCO_train_year, 'train')]
    cfg = (COCO_300_mod, COCO_512)[args.size == '512']
...
if args.version == 'RFB_vgg':
    ...
    from models.SSD_vgg_mod import build_net
...
if args.dataset == 'VOC':
    ...
    testset = COCODetection(
        COCOroot, [(COCO_train_year, 'val')], None)
